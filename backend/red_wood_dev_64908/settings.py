"""
Django settings for red_wood_dev_64908 project.
...
ROOT_URLCONF = 'red_wood_dev_64908.urls'
...
WSGI_APPLICATION = 'red_wood_dev_64908.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_wood_dev_64908 API",
    "DESCRIPTION": "API documentation for red_wood_dev_64908 App",
    "VERSION": "v1",
}
